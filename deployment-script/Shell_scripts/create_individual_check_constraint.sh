...
rm -rf Check_constraint_error_log.log

ERROR_LOG=Check_constraint_error_log.log

myfolders[0]="Check_constraint"



now=$(date +"%T")
echo "Check_constraint creation STARTED : $now"
echo "Check_constraint creation STARTED : $now" >> $ERROR_LOG 2>&1
...
now=$(date +"%T")
echo "Check_constraint creation END : $now"
echo "Check_constraint creation END : $now" >> $ERROR_LOG 2>&1
