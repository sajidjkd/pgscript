...
rm -rf Foreign_key_error_log.log

ERROR_LOG=Foreign_key_error_log.log

myfolders[0]="Foreign_key"



now=$(date +"%T")
echo "Foreign_key creation STARTED : $now"
echo "Foreign_key creation STARTED : $now" >> $ERROR_LOG 2>&1
...
now=$(date +"%T")
echo "Foreign_key creation END : $now"
echo "Foreign_key creation END : $now" >> $ERROR_LOG 2>&1
